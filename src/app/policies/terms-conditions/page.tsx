        ...
        <ConstrainedBox classNames="px-4 py-8 z-20">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p>
                By accessing and using this website (saikattanti.dev, with the previous domain kept only as a temporary legacy redirect during transition), you accept and agree to be bound 
